...
<table>
  <tr>
   ...
   <tr>
    ...
    <td><a href="/paypal.php?p=1&i=<?= htmlspecialchars($player['userId'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><img src="/do_img/buy-now-green.png"></a></td>
	</tr>
  <tr>
    ...
    <td><a href="/paypal.php?p=2&i=<?= htmlspecialchars($player['userId'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><img src="/do_img/buy-now-green.png"></a></td>
	</tr>
  <tr>
    ...
    <td><a href="/paypal.php?p=3&i=<?= htmlspecialchars($player['userId'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><img src="/do_img/buy-now-green.png"></a></td>
	</tr>
   <tr>
    ...
    <td><a href="/paypal.php?p=4&i=<?= htmlspecialchars($player['userId'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><img src="/do_img/buy-now-green.png"></a></td>
	</tr>
   <tr>
    ...
    <td><a href="/paypal.php?p=5&i=<?= htmlspecialchars($player['userId'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><img src="/do_img/buy-now-green.png"></a></td>
	</tr>
   <tr>   
    ...
    <td><a href="/paypal.php?p=6&i=<?= htmlspecialchars($player['userId'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><img src="/do_img/buy-now-green.png"></a></td>
  </tr>
  <tr>
    ...
    <td><a href="/paypal.php?p=7&i=<?= htmlspecialchars($player['userId'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><img src="/do_img/buy-now-green.png"></a></td>
  </tr>
  <tr>
    ...
    <td><a href="/paypal.php?p=8&i=<?= htmlspecialchars($player['userId'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><img src="/do_img/buy-now-green.png"></a></td>
  </tr>
  <tr>
    ...
    <td><a href="/paypal.php?p=9&i=<?= htmlspecialchars($player['userId'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><img src="/do_img/buy-now-green.png"></a></td>
	</tr>
  <tr>
    ...
    <td><a href="/paypal.php?p=10&i=<?= htmlspecialchars($player['userId'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><img src="/do_img/buy-now-green.png"></a></td>
  </tr>
  <tr>
    <td><img src="/do_img/global/items/uri1_big.png" width="50px">  <strong style="color:#9DC208;"> 500000 uridium </em></td>
	<td><strong style="color:#9DC208;">5.99€</td>
    <td><a href="/paypal.php?p=11&i=<?= htmlspecialchars($player['userId'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><img src="/do_img/buy-now-green.png"></a></td>
  </tr>
  <tr>
    <td><img src="/do_img/global/items/uri1_big.png" width="50px"> <strong style="color:#9DC208;"> 1500000 uridium </em></td>
	<td><strong style="color:#9DC208;">8.99€</td>
    <td><a href="/paypal.php?p=12&i=<?= htmlspecialchars($player['userId'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><img src="/do_img/buy-now-green.png"></a></td>
  </tr>
  <tr>
    ...
    <td><a href="/paypal.php?p=13&i=<?= htmlspecialchars($player['userId'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><img src="/do_img/buy-now-green.png"></a></td>
	</tr>
  <tr>
    ...
    <td><a href="/paypal.php?p=14&i=<?= htmlspecialchars($player['userId'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><img src="/do_img/buy-now-green.png"></a></td>
	</tr>
  <tr>
    ...
    <td><a href="/paypal.php?p=15&i=<?= htmlspecialchars($player['userId'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><img src="/do_img/buy-now-green.png"></a></td>
	</tr>
  <tr>
...
These contents are available. </em></td>
	<td><strong style="color:#9DC208;">5.99€</td>
    <td><a href="/paypal.php?p=16&i=<?= htmlspecialchars($player['userId'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><img src="/do_img/buy-now-green.png"></a></td>
	</tr>
  <tr>
...
These contents are available. </em></td>
	<td><strong style="color:#9DC208;">40.99€</td>
    <td><a href="/paypal.php?p=17&i=<?= htmlspecialchars($player['userId'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><img src="/do_img/buy-now-green.png"></a></td>
	</tr>
  <tr>
    ...
    <td><a href="/paypal.php?p=18&i=<?= htmlspecialchars($player['userId'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><img src="/do_img/buy-now-green.png"></a></td>
	</tr>
  <tr>
    ...
    <td><a href="/paypal.php?p=19&i=<?= htmlspecialchars($player['userId'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><img src="/do_img/buy-now-green.png"></a></td>
	</tr>
  <tr>
    ...
    <td><a href="/paypal.php?p=20&i=<?= htmlspecialchars($player['userId'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><img src="/do_img/buy-now-green.png"></a></td>
	</tr>
  <tr>
    ...
    <td><a href="/paypal.php?p=21&i=<?= htmlspecialchars($player['userId'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><img src="/do_img/buy-now-green.png"></a></td>
	</tr>
  <tr>
    ...
    <td><a href="/paypal.php?p=22&i=<?= htmlspecialchars($player['userId'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><img src="/do_img/buy-now-green.png"></a></td>
	</tr>
  <tr>
    ...
    <td><a href="/paypal.php?p=23&i=<?= htmlspecialchars($player['userId'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><img src="/do_img/buy-now-green.png"></a></td>
    </tr>
  <tr>
