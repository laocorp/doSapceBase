...
if ($sQuery3->num_rows > 0){
    while($data3 = $sQuery3->fetch_assoc()){
        ...
        if (!empty($data3['checkLaser'])){
            ...
            $stmt_player_equip->bind_param("i", $player['userId']);
        ...
        if ($availableLasers > 0){
            ...
            $stmt_in_process->bind_param("ii", $data3['id'], $player['userId']);
...
<div class="level" id="level_<?= $data3['id']; ?>">Level <?= htmlspecialchars($laserLvl, ENT_QUOTES, 'UTF-8'); ?></div>
</div>
...
<div class="img"><img src="<?= htmlspecialchars($data3['image'], ENT_QUOTES, 'UTF-8'); ?>"></div>
<div class="name"><?= htmlspecialchars($data3['name'], ENT_QUOTES, 'UTF-8'); ?></div>
<div class="level" id="level_<?= $data3['id']; ?>">Level <?= htmlspecialchars($shieldLvl, ENT_QUOTES, 'UTF-8'); ?></div>
</div>
...
<div class="img"><img src="<?= htmlspecialchars($data3['image'], ENT_QUOTES, 'UTF-8'); ?>"></div>
<div class="name"><?= htmlspecialchars($data3['name'], ENT_QUOTES, 'UTF-8'); ?></div>
<div class="level" id="level_<?= $data3['id']; ?>">Level <?= htmlspecialchars($droneLvl, ENT_QUOTES, 'UTF-8'); ?></div>
</div>
    <?php
...
$stmt_upgrading->bind_param("i", $player['userId']);
...
<div class="progress2" id="PitemId_<?= $dataUP['id']; ?>" data-id="<?= $dataUP['id']; ?>"><progress max="100" value="<?= htmlspecialchars($completed, ENT_QUOTES, 'UTF-8'); ?>"></progress></div>
</div>
